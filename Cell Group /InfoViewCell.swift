...
class InfoViewCell: UICollectionViewCell {
    ...
    var progressPercentage = UILabel()
    ...
    private func setupViews(){
        ...
        self.layer.borderColor = UIColor(named: "Gray3")?.cgColor
        
        //maiTitle setup
        mainTitle.font = UIFont.boldSystemFont(ofSize: 24)
        mainTitle.textColor = UIColor(named: "Dark")
        //mock text
        ...
        progressBar.trackColor = UIColor(named: "Green2")!
    ...
    private func setupLayout(){
        ...
        secondaryTitle.snp.makeConstraints { make in
            if arrowIndicator.image == UIImage(named: "upArrow"){
